...
java最新版本java11(LTS)版本今天刚刚发布，我们下载java8即可（java9,10均为过度版本），打开上面网址，往下拖，
找到Java SE 8u181(8表示版本号，u181表示小版本号，小版本号多为安全性更新，对使用没有影响)，选择对应系统版本，
下载安装即可（傻瓜式安装，一路下一步即可，其实就是解压一下）。
